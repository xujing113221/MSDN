...
ext_modules = [
    Extension("utils.cython_bbox", ["utils/bbox.pyx"], extra_compile_args={"gcc": ["-Wno-cpp", "-Wno-unused-function"]}, include_dirs=[numpy_include]),
    ...
    Extension(
        ...
        extra_compile_args={"gcc": ["-Wno-unused-function"], "nvcc": ["-arch=sm_35", "--ptxas-options=-v", "-c", "--compiler-options", "'-fPIC'"]},
